    ...
    <Accordion allowToggle defaultIndex={[0]}>
      <AccordionItem>
        ...
        <AccordionPanel pb={4}>
          ...
          tracking their orders and gaining insights into the expected delivery
          times. By aggregating information from different carriers, it ensures
          a seamless and efficient tracking process, ultimately enhancing the
        ...
        <AccordionPanel pb={4}>
          ...
          &ldquo;Device Bundler&rdquo; is built as a microservices architecture
          within an orchestration distribution framework. It exemplifies a
          forward-thinking approach to customer service and e-commerce in
      ...
      <AccordionItem>
        ...
        <AccordionPanel pb={4}>
          Initiative: Enterprise Portal The Enterprise Portal is a user-friendly
          web-based application designed to enhance the user experience by
          providing the following features: ü Centralized Access: It
          consolidates all reports and products from various pillars into a
          single, easily accessible platform. ü Streamlined Administration:
          Different administrators for different pillars are efficiently managed
          and controlled by a super admin, ensuring smooth operations. ü
          Personalized Favorites: Users can conveniently manage their favorite
          items, tailoring their experience to their preferences.
        </AccordionPanel>
        <AccordionPanel pb={4}>
      ...
      <AccordionItem>
        ...
        <AccordionPanel pb={4}>
          ...
          Permit (WDP), initiated by the Victorian government, aids individuals
          unable to pay fines. WDP application acts as a platform for sponsor
          organizations, including medical practitioners, to apply for clients
          facing financial constraints. Clients collaborate with sponsors to
          resolve fines through accredited activities like unpaid work and
          counselling. This innovative approach supports those in need,
          encourages community engagement, and offers an alternative to
      ...
      <AccordionItem>
        ...
        <AccordionPanel pb={4}>
          Project: Myki – Ticketing system Myki, one of the world&apos;s largest
          smartcard ticketing systems, partners with NTT Data for innovative
          ticketing strategy development and implementation. Vix Technology
          provides ticketing gates and supports PTV in simplifying the ticketing
          system.
        </AccordionPanel>
      </AccordionItem>
      ...
      <AccordionItem>
        ...
        <AccordionPanel pb={4}>
          ...
          significant financial loss. As a developer, analyzed and enhanced the
      ...
      <AccordionItem>
        ...
        <AccordionPanel pb={4}>
          Project: Mort – Consumer Business Application Mort – Phase 2 is built
          to implement the Consumer’s business data, migrated to Big Data
          environment. This helps the Business to manage the credit risk of an
          individual along with their Personal information’s with cost
          efficient.
        </AccordionPanel>
        <AccordionPanel pb={4}>
          Project: Mort – Data Source Migration Mort – Phase 1 is to test the
          Data-Load applications to meet the Functional/Business requirement and
          load the legacy data into DB2 tables (millions of data) Data-Load
          repository and automate the application. Provide warranty support till
          the application is stable. Develop a Personal Data information with
          the migrated data and build a separate repository with an application
          and automate it daily basis.
        </AccordionPanel>
      </AccordionItem>
    </Accordion>
  );
