...
const skills = [
  ...
  { category: 'programming language & framework', name: 'nest', alt: 'nest', src: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nestjs/nestjs-original.svg' },
  ...
  { category: 'programming language & framework', name: 'nodejs', alt: 'nodejs', src: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original-wordmark.svg' },
  ...
  { category: 'programming language & framework', name: 'bootstrap', alt: 'bootstrap', src: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/bootstrap/bootstrap-original-wordmark.svg' },
  ...
  { category: 'programming language & framework', name: 'tailwindcss', alt: 'tailwindcss', src: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original-wordmark.svg' },
  { category: 'programming language & framework', name: 'reactbootstrap', alt: 'reactbootstrap', src: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/reactbootstrap/reactbootstrap-original.svg' },
  ...
  { category: 'database', name: 'dynamodb', alt: 'dynamodb', src: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/dynamodb/dynamodb-original.svg' },
  ...
  { category: 'design', name: 'photoshop', alt: 'photoshop', src: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/photoshop/photoshop-original.svg' },
